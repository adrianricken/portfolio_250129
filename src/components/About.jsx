...
const About = () => {
  return (
    <>
      <div className="flex justify-center md:min-h-screen mt-10 md:mt-0">
        <div className="relative w-full max-w-[1680px] h-content md:min-h-screen grid grid-cols-1 md:grid-cols-[2fr_3fr] lg:grid-cols-[1fr_2fr]">
          {/* Linker Container */}
          <div className="relative flex flex-col items-center md:px-15 pt-10 md:pt-15 md:border-r-2 md:border-dotted">

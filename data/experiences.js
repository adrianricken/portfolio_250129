const experiences = [
  ...
  },
  {
    ...
    content:
      "Im Rahmen meiner Praktika und Werkstudententätigkeiten konnte ich wertvolle Erfahrungen in den Bereichen Planung, Design und technische Umsetzung sammeln. Meine Aufgaben umfassten unter anderem die 3D-Modellierung von Bau- und Fabrikstrukturen, den Aufbau von Komponentenbibliotheken sowie die Erstellung und Prüfung von Layouts nach geltenden Normen. Durch die enge Zusammenarbeit mit interdisziplinären Teams konnte ich mein Wissen in strukturiertem Planen, normgerechter Gestaltung und effizienten Arbeitsabläufen vertiefen. Zudem habe ich wertvolle Einblicke in die industrielle Planung, architektonische Gestaltung und prozessoptimierte Flächenkonzeption gewonnen. Die Arbeit an realen Projekten hat es mir ermöglicht, meine analytischen und konzeptionellen Fähigkeiten zu schärfen und kreative, nutzerzentrierte Lösungen zu entwickeln. Gleichzeitig habe ich meine Kommunikations- und Teamarbeitsskills gestärkt, indem ich eng mit Ingenieuren, Designern und Planern zusammengearbeitet habe.",
  },
  {
    id: 3,
